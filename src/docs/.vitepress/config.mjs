...
export default defineConfig({
  ...
  head: [
    [
      'link',
      { rel: 'icon', href: '/docs/favicon-32x32.svg', type: 'image/svg+xml' },
    ],
    [
      'link',
      { rel: 'icon', href: '/docs/favicon-16x16.svg', type: 'image/svg+xml' },
    ],
  ],
  //主题相关的配置
  themeConfig: {
    ...
    socialLinks: [
      {
        ...
        link: 'https://gitee.com/ajiho/adminlts',
      },
    ],
    //页面底部的编辑此页面
    editLink: {
      pattern: 'https://gitee.com/ajiho/adminlts/tree/2.x/build/docs/:path',
      text: '在Gitee上编辑此页面',
    },
