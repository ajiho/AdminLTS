...
(function (global, factory) {
  ...
  var Quicktab = /*#__PURE__*/function () {
    ...
    _proto.activeTabById = function activeTabById(id) {
      ...
      for (var _iterator = _createForOfIteratorHelperLoose(_this._tab_pane_wraper.children), _step; !(_step = _iterator()).done;) {
      ...
      //给当前的面板移进视野
      _this.getTabPaneById(id).classList.remove(TAB_PANE_HIDE_CLASS_NAME);
        ...
        if (loading instanceof HTMLElement) {
          ...
          loading.addEventListener('transitionend', function () {
            ...
            if (_this._option.onTabMaskTransitionend) {
              var _tabEl = _this.getTabById(id);
              var _tabId = Quicktab.getTabId(_tabEl);
              var _tabUrl = Quicktab.getTabUrl(_tabEl);
              var _tabPaneEl = _this.getTabPaneById(id);
              var _tabIFrame = {
                el: _this.getIFrameById(id),
                canAccess: Quicktab.canAccessIFrame(_this.getIFrameById(id))
              };
              _this._option.onTabMaskTransitionend({
                target: _this,
                tabEl: _tabEl,
                tabId: _tabId,
                tabUrl: _tabUrl,
                tabPaneEl: _tabPaneEl,
                tabIFrame: _tabIFrame
              });
            }
          });
        }
