...
var FullCalendar = (function (exports) {
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence lib don't guarantee that all-day events are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    function buildEventSourceMeta(raw, context) {
        ...
        for (var i = defs.length - 1; i >= 0; i -= 1) { // later-added lib take precedence
            var def = defs[i];
    ...
    */
    ...
    /*
    this array is exposed on the root namespace so that UMD lib can add to it.
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
            ...
            for (var optionName in raw) {
                if (optionName !== 'plugins') { // because lib is special-cased
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            if (!viewSpec) {
                throw new Error("viewType \"" + viewType + "\" is not available. Please make sure you've loaded all neccessary lib");
            }
    ...
    */
    ...
    BootstrapTheme.prototype.classes = {
        root: 'fc-themes-bootstrap5',
        tableCellShaded: 'fc-themes-bootstrap5-shaded',
        buttonGroup: 'btn-group',
        button: 'btn btn-primary',
        buttonActive: 'active',
        popover: 'popover',
